                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-6 col-md-3 item">
                                ...
                                <ul>
                                    <li><a aria-label={"Sell your goods on RocketNow"} href="/">Sell on RocketNow</a>
                                    </li>
                                    <li><a aria-label={"See the answers to the most frequently asked questions"} href="http://rocketnow.eu/faq">FAQ</a>
                                    </li>
                            ...
                            <div className="col item social">
                                ...
                                <a title={"View RocketNow on LinedIn"} href="#"><i className="icon ion-social-linkedin"/></a>
                            </div>
                        </div>
