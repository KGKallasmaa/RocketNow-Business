                    ...
                    <li className="nav-item dropdown no-arrow" role="presentation">
                        <li className="nav-item dropdown no-arrow">
                            <a
                                ...
                                <span
                                    className="d-none d-lg-inline mr-2 text-gray-600 small">{localStorage.getItem("businessDisplayName")}
                                </span>
                                <img
                                    alt={altMessage}
                            ...
                            <div className="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                                ...
                                <a className="dropdown-item" role="presentation" href="/logout"><i
