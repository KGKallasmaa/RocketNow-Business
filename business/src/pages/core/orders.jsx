...
import {PARTIALORDER_QUERY} from "../../graphql/core/order/partialOrder_QUERY";
import {NR_OF_ORDERDS_PROCESSING_NOT_STARTED_QUERY} from "../../graphql/core/order/nrOfOrderdsProcessingNotStarted_QUERY";
import {NR_OF_NOT_SHIPPED_ORDERS_QUERY} from "../../graphql/core/order/nrOfNotShippedOrders_QUERY";
import {UN_COMPLETED_ORDERS_VALUE_QUERY} from "../../graphql/core/order/unCompletedOrdersValue_QUERY";
import {NR_OF_IN_PROGRESS_ORDERS_QUERY} from "../../graphql/core/order/nrOfInProgressOrders_QUERY";
...
export default class Order extends React.Component {
    ...
    render() {
        ...
        const cannonial_url = process.env.REACT_APP_PUBLIC_URL + "/orders";
        return (
            <div id="page-top">
                <Helmet>
                    <title>Orders</title>
