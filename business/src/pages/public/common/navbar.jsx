                ...
                <div className="container"><a className="navbar-brand" href="/">RocketNow</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarResponsive">
                        <ul className="nav navbar-nav ml-auto">
                            <li className="nav-item" role="presentation"><a className="nav-link" href="/signup">Sign Up</a>
                            </li>
                            <li className="nav-item" role="presentation"><a className="nav-link" href="/login">Log In</a>
                            </li>
                        </ul>
                    </div>
                </div>
