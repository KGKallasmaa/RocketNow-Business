...
class NormalLoginForm extends React.Component {
    ...
    BusinessLoginSubmit = (event) => {
        ...
        axios.post(process.env.REACT_APP_SERVER_URL, {
            ...
            localStorage.setItem("jwtToken_business", base.token);
            localStorage.setItem("jwtToken_expires_business", base.tokenExpiration);
            localStorage.setItem("businessDisplayName", base.businessDisplayName);
            localStorage.setItem("businessLegalName", base.businessLegalName);
            localStorage.setItem("logoURL", base.logoURL);
